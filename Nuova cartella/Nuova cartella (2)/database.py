...
class SQLiteWriter:
    ...
    #def decrypto_db(self, enc_file=None, dec_file=None, path_key="key.key", suppress_prompt=False):
    #def decrypto_db(self, path_key="key.key", output_filename=None, suppress_prompt=False):
    def decrypto_db(self, path_key="key.key", output_filename=None, suppress_prompt=False, enc_file=None):
        """
       ...
       # encrypted_filename = self.filename + ".enc"
        #encrypted_filename = enc_file if enc_file else self.db_name + ".enc"
        #output_filename = dec_file if dec_file else self.db_name
       ...
       # output_file = output_filename if output_filename else self.filename
        ...
        #with open(output_filename, "wb") as file_dec:
